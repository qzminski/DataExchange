 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_dataexchange_config']['name']               = array('Name', 'Please enter a name for this DataExchange configuration.');
...
$GLOBALS['TL_LANG']['tl_dataexchange_config']['prependString']      = array('File name prefix', 'Prepend string for output file. Insert Tags are replaced.');
...
$GLOBALS['TL_LANG']['tl_dataexchange_config']['export']     = array('Export configuration', 'Export configuration ID %s');
